...
Page({
    ...
    onLoad: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t);
                var e = t.data;
                "2" == (getApp().xtxx = e).model && (getApp().sjid = e.default_store), "4" == e.model && (getApp().sjid = e.default_store), 
                app.pageOnLoad(a), "" == t.data.dc_name && (t.data.dc_name = "店内"), "" == t.data.wm_name && (t.data.wm_name = "外卖"), 
                a.setData({
                    System: t.data
                });
            }
    ...
    reLoad: function() {
        var t, a = this, e = this.data.status || 1, o = wx.getStorageSync("users").id, s = this.data.pagenum;
        1 == e && (t = "1"), 2 == e && (t = ""), 3 == e && (t = ""), "4" == e && (e = "4,5", 
        t = "2"), "5" == e && (e = "6,7,8,9,10", t = "3"), console.log(e, t, o, s), app.util.request({
