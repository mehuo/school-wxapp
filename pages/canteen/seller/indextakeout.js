...
Page({
    ...
    onLoad: function(t) {
        ...
        var c = this, l = c.data.store_id, g = util.formatTime(new Date()).slice(11, 16);
        app.util.request({
            url: "entry/wxapp/Url",
            cachetime: "0",
            success: function(d) {
                console.log(d.data), getApp().imgurl = d.data, c.setData({
                    ...
                    success: function(t) {
                        ...
                        console.log("当前的系统时间为" + g), console.log("商家的营业时间从" + a + "至" + e, o + "至" + s), 
                        1 == i ? (c.setData({
                            yysjtoggle: !1
                        }), console.log("商家正在休息" + i)) : console.log("商家正在营业" + i), a < s ? a < g && g < e || o < g && g < s ? (console.log("商家正常营业"), 
                        c.setData({
                            time: 1
                        })) : g < a || e < g && g < o ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), c.setData({
                            time: 2,
                            yysjtoggle: !1
                        })) : s < g && (console.log("商家以及关店啦，明天再来吧"), c.setData({
                            time: 3,
                            yysjtoggle: !1
                        })) : s < a && (a < g && g < e || o < g && s < g || g < o && g < s ? (console.log("商家正常营业"), 
                        c.setData({
                            time: 1
                        })) : g < a || e < g && g < o ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), c.setData({
                            time: 2,
